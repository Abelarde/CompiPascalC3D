program matrices;
	...
	const
		...
		max = 4;
    type
        matriz2 = array [0..4, 0..4] of integer;
		matrixR2 = array [0..4, 0..4] of integer;
		matrixA2 = array [0..4,0..4] of integer;
        matrixB2  = array [0..4,0..4] of integer;
    var
    matriz2:matriz;
    matrixR2:matrixR;
    matrixA2:matrixA;
...
type
	matrixAux2 = array[0..4,0..4] of integer;
var
     matrixAux : matrixAux2;
	i,j : integer;
